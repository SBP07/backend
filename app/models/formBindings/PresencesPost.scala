...
object PresencesPost {
  ...
  def presencesToDelete(selectedActivities: List[Activity], possibleActivities: List[Activity], alreadyPersisted: List[Activity]): List[Activity] = {
  ...
  def presencesToInsert(selectedActivities: List[Activity], possibleActivities: List[Activity], alreadyPersisted: List[Activity]): List[Activity] = {
